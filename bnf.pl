...
analizar(List,Res):-caracteristicas_bd(estatura,A),
    ...
    union(Q,[si,'no_se','no_tengo_idea','ni_idea','quien_sabe','no_me_acuerdo','nose','no','hola'],R),
    intersection(R,List,Res).
...
sustantivo(S1,S).
sintagma_verbal(S0,S):- verbo(S0,S1),
sustantivo(S1,S2),adjetivo(S2,S).
sintagma_verbal(S0,S):- verbo(S0,S1),
sustantivo(S1,S2),adjetivo(S2,S3),articulo(S3,S4),adjetivo(S4,S).
sintagma_verbal(S0,S):- verbo(S0,S1),articulo(S1,S2),
sustantivo(S2,S3),adjetivo(S3,S4),articulo(S4,S5),adjetivo(S5,S).
sintagma_verbal(S0,S):- verbo(S0,S1),
adjetivo(S1,S).
sintagma_verbal(S0,S):- verbo(S0,S1),
...
sustantivo(S2,S).
sintagma_verbal(S0,S):- verbo(S0,S1),articulo(S1,S2),
sustantivo(S2,S3), adjetivo(S3,S).
sintagma_verbal(S0,S):- verbo(S0,S1),articulo(S1,S2),
adjetivo(S2,S).
...
sustantivo([ingeniero_mecanico|S],S).
...
sustantivo([director_de_cine|S],S).
sustantivo([actor|S],S).
sustantivo([comediante|S],S).
sustantivo([miss_costa_rica|S],S).
sustantivo([anos|S],S).
sustantivo([años|S],S).
sustantivo([cm|S],S).
...
sustantivo(['san_jose'|S],S).
sustantivo([españa|S],S).
sustantivo([guanacaste|S],S).
sustantivo([londres|S],S).
sustantivo([cuba|S],S).
sustantivo(['san_ramon'|S],S).
...
otros([no_lo_se|S],S).
otros([ni_idea|S],S).
otros([no_tengo_idea|S],S).
otros([quien_sabe|S],S).
otros([no_me_acuerdo|S],S).
otros([holaa|S],S).
